...
namespace DataAccessLibrary
{
    public class MySqlCrud
    {
        ...
        {
            string sql = "Select Id, FirstName, LastName From Associate;";
        ...
        {
            string sql = "Select Id, FirstName, LastName From Associate Where Id = @Id";
        ...
        {
            string sql = "Insert Into Associate (FirstName, LastName) Values (@FirstName, @LastName);";
            ...
            sql = "Select Id From Associate Where FirstName = @FirstName And LastName = @LastName;";
            ...
            foreach (var location in associate.Locations)
            {
                if (location.Id == 0)
                {
                    ...
                    sql = "Select Id From Location Where LocationName = @LocationName;";
                ...
                sql = "Insert Into AssociateLocation (AssociateId, LocationId) Values (@AssociateId, @LocationId);";
            ...
            foreach (var shift in associate.Shifts)
            {
                if (shift.Id == 0)
                {
                    sql = "Insert Into Shift (ShiftName) Values (@ShiftName);";

                    db.SaveData(sql, new { shift.ShiftName }, _connectionString);

                    sql = "Select Id From Shift Where ShiftName = @ShiftName;";
                ...
                sql = "Insert Into AssociateShift (AssociateId, ShiftId) Values (@AssociateId, @ShiftId);";
        ...
        {
            string sql = "Update Associate Set FirstName = @FirstName, LastName = @LastName Where Id = @Id;";
        ...
        public void RemoveLocationFromAssociate(int associateId, int locationId)
        {
            ...
            sql = "Delete From AssociateLocation Where LocationId = @LocationId And AssociateId = @AssociateId;";
